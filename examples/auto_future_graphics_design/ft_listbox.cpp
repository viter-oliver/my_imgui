...
void ft_listbox::draw()
{
	...
	if (is_selected())
	{
		...
		ImVec2 pos1a = apos - editunit;
		ImVec2 pos1b = apos + editunit;
		ImGui::RenderFrame(pos1a, pos1b, col);
		ImVec2 pos2(szpos.x, apos.y);
		ImVec2 pos2a = pos2 - editunit;
		ImVec2 pos2b = pos2 + editunit;
		ImGui::RenderFrame(pos2a, pos2b, col);
		ImVec2 pos3a = szpos - editunit;
		ImVec2 pos3b = szpos + editunit;
		ImGui::RenderFrame(pos3a, pos3b, col);
		ImVec2 pos4(apos.x,szpos.y);
