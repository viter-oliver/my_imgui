...
void ft_particles::draw_peroperty_page()
{
...
bool ft_particles::init_from_json(Value& jvalue)
{
	return true;
}
bool ft_particles::init_json_unit(Value& junit)
{
	return true;
}
#endif