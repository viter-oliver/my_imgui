                         ...
                         try
                         {
                              if (afg_fs::is_regular_file(dir_itr->status()))
                              {
                                   ...
                                   if (file_unit.file_name.find(str_reg) != string::npos)
                                   {
                                        ...
                                        if (i_pid > g_prj_backup_mg.max_back_id)
                                             g_prj_backup_mg.max_back_id = i_pid;
...
#define LICENSE_LEN 0x100
               ...
               if (ImGui::Button("Ok"))
               {
                    ...
                    else
                    {
                         ...
                         if (mac_address_bt[0] != plain_text[8] || mac_address_bt[1] != plain_text[9] || mac_address_bt[2] != plain_text[10] || mac_address_bt[3] != plain_text[11] || mac_address_bt[4] != plain_text[12] || mac_address_bt[5] != plain_text[13])
                         {
          ...
          if (ImGui::GetIO().KeyCtrl)
          {
               ...
               else if (ImGui::IsKeyReleased(GLFW_KEY_O))
               {
                    fun_shortct(en_ctrl_o);
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_N))
               {
                    fun_shortct(en_ctrl_n);
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_B))
               {
                    fun_shortct(en_ctrl_b);
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_H))
               {
               ...
               else if (ImGui::IsKeyReleased(GLFW_KEY_F2))
               {
                    fun_shortct(en_ctrl_f2);
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_Z) && g_ui_edit_command_mg.undo_able())
               {
                    g_ui_edit_command_mg.undo_command();
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_Y) && g_ui_edit_command_mg.redo_able())
               {
          ...
          else if (ImGui::GetIO().KeyShift)
          {
               ...
               else if (ImGui::IsKeyReleased(GLFW_KEY_X))
               {
                    prj_edit->cut_item();
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_V))
               {
                    prj_edit->past_item();
               }
               else if (ImGui::IsKeyReleased(GLFW_KEY_A))
               {
          ...
          else if (show_state_manager_edit)
          {
