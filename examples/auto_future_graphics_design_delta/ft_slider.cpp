...
#define ARRAY_COUNT_DIRECTION_ITEM 3
	...
	bool ft_slider::init_from_json(Value& jvalue)
	{
		...
		_slider_pt._position_nml = jvalue["progress_value"].asDouble();
		...
		_slider_pt._texture_bg_index_txt = bg["bg_texture_index"].asInt();
		_slider_pt._bg_angle_nml = bg["bg_angle"].asDouble();

		Value& head = jvalue["head_pos"];
		_slider_pt._hd_posy = head["head_pos_h"].asDouble();
		_slider_pt._hd_posx = head["head_pos_w"].asDouble();
		_slider_pt._texture_head_index_txt = head["head_texture_index"].asInt();

		Value& thumb = jvalue["thumb_pos"];
		_slider_pt._tb_posy = thumb["thumb_pos_h"].asDouble();
		_slider_pt._tb_posx = thumb["thumb_pos_w"].asDouble();
		_slider_pt._texture_thumb_index_txt = thumb["thumb_texture_index"].asInt();
	...
	bool ft_slider::init_json_unit(Value& junit)
	{
		...
		junit["progress_value"] = _slider_pt._position_nml;
		...
		bg["bg_texture_index"] = _slider_pt._texture_bg_index_txt;
		bg["bg_angle"] = _slider_pt._bg_angle_nml;
		junit["bg_pos"] = bg;

		Value head(objectValue);
		head["head_pos_w"] = _slider_pt._hd_posx;
		head["head_pos_h"] = _slider_pt._hd_posy;
		head["head_texture_index"] = _slider_pt._texture_head_index_txt;
		junit["head_pos"] = head;

		Value thumb(objectValue);
		thumb["thumb_pos_w"] = _slider_pt._tb_posx;
		thumb["thumb_pos_h"] = _slider_pt._tb_posy;
		thumb["thumb_texture_index"] = _slider_pt._texture_thumb_index_txt;
