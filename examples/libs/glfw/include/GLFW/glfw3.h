...
/*! @brief The function signature for notification of camera callbacks.
* This is the function signature for  notification of plug or unplug of 
* camera callbacks.
*@param[in] event One of `GLFW_CONNECTED` or `GLFW_DISCONNECTED`.
*/
typedef void(*GLFWnotifyfun)(int, wchar_t*);
