...
bool    ImGui_ImplGL3_Init(bool install_callbacks, const char* glsl_version)
{
...
void set_display(float w,float h)
{
    ImGuiIO& io = ImGui::GetIO();
    proj_item(0,0)=2.f/w;
    proj_item(1,1)=-2.f/h;
