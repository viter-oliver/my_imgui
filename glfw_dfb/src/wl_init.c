                                   ...
                                   enum wl_seat_capability caps)
{
    ...
    if ((caps & WL_SEAT_CAPABILITY_TOUCH)&&!_glfw.wl.pointer) {
	printf("Display has a touch screen\n");

        _glfw.wl.pointer = wl_seat_get_pointer(seat);
        //wl_pointer_add_listener(_glfw.wl.pointer, &pointerListener, NULL);
        struct touch *touch = data;
        wl_touch= wl_seat_get_touch(seat);
        wl_touch_set_user_data(wl_touch, touch);
        wl_touch_add_listener(wl_touch, &touch_listener, touch);
    }
    if ((caps & WL_SEAT_CAPABILITY_POINTER) && !_glfw.wl.pointer)
    {
        printf("platform has a pointer capability\n");
        _glfw.wl.pointer = wl_seat_get_pointer(seat);
        wl_pointer_add_listener(_glfw.wl.pointer, &pointerListener, NULL);
    }
	...
	printf("Display has a touch screen\n");
        ...
        wl_touch_set_user_data(_glfw.wl.touch, touch);
        wl_touch_add_listener(_glfw.wl.touch, &touch_listener, touch);
    }*/
}
