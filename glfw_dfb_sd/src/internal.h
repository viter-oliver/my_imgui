...
typedef struct _GLFWwindowDFB
{
	void* native;
	int width,height;
} _GLFWwindowDFB;
#define _GLFW_PLATFORM_WINDOW_STATE _GLFWwindowDFB dfb
#define _GLFW_EGL_NATIVE_WINDOW window->dfb.native
...
//#define _GLFW_PLATFORM_TLS_STATE
