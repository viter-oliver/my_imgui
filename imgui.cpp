...
void ImGui::ImageQuad(ImTextureID user_texture_id, const ImVec2& vp0, const ImVec2& vp1, const ImVec2& vp2, const ImVec2& vp3, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& uv2, const ImVec2& uv3, const ImVec4& tint_col, const ImVec4& border_col)
{
	ImGuiWindow* window = GetCurrentWindow();
	if (window->SkipItems)
		return;
	...
	*/
	...
	window->DrawList->AddImageQuad(user_texture_id, vp0, vp1, vp2, vp3, uv0, uv1, uv2, uv3, GetColorU32(tint_col));
}
