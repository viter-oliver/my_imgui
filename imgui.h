...
namespace ImGui
{
	...
	IMGUI_API void          ImageQuad(ImTextureID user_texture_id, const ImVec2& vp0, const ImVec2& vp1, const ImVec2& vp2, const ImVec2& vp3, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& uv2, const ImVec2& uv3, const ImVec4& tint_col = ImVec4(1, 1, 1, 1), const ImVec4& border_col = ImVec4(0, 0, 0, 0));
...
struct ImDrawCmd
{
	...
	/*float           *pcustom_matrix;*/
	ImDrawCmd() { ElemCount = 0; ClipRect.x = ClipRect.y = ClipRect.z = ClipRect.w = 0.0f; TextureId = NULL; UserCallback = NULL; UserCallbackData = NULL; /*pcustom_matrix = identity_matrix[0];*/ }
};
...
struct ImDrawList
{
	...
	//IMGUI_API void  set_custom_maxtrix(float *pmatr);
