...
int main(int argc, char const *argv[]) {
    ...
    show(obj);
	std::string  strk = "akey";
	std::string strv = "avalue";
	MsgPack test_obj = MsgPack::object{ {strk, strv }};
	MsgPack test_obj2 = MsgPack::object{ { strk, test_obj } };
    MsgPack::object testobj3={ { strk, test_obj2 } };
	testobj3[test_obj] = test_obj2;
	std::ofstream fout;
	fout.open("testmsgpack");
	fout << test_obj2.dump() << std::endl;
	fout.close();
