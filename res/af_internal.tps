...
<data version="1.0">
    <struct type="Settings">
        ...
        <string>4.6.3</string>
        <key>fileName</key>
        <string>G:/GitHub/my_imgui/my_imgui/res/af_internal.tps</string>
        ...
        <key>fileList</key>
        <array>
            <filename>UI icon/ft_base.png</filename>
            <filename>UI icon/ft_button.png</filename>
            <filename>UI icon/ft_image.png</filename>
            <filename>UI icon/ft_listbox.png</filename>
            <filename>UI icon/ft_polygon_image.png</filename>
            <filename>UI icon/ft_slider.png</filename>
