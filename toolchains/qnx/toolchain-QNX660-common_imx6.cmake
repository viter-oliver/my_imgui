...
set (CMAKE_C_FLAGS_MINSIZEREL "-Os -DNDEBUG -fpack-struct")
set (CMAKE_C_FLAGS_RELEASE "-O3 -DNDEBUG -fpack-struct")
set (CMAKE_C_FLAGS_RELWITHDEBINFO "-O2 -g -fpack-struct")

#set (CMAKE_CXX_COMPILER ${QNX_HOST}/usr/bin/nto${CMAKE_SYSTEM_PROCESSOR}-gcc${HOST_EXECUTABLE_SUFFIX})
set (CMAKE_CXX_COMPILER ${QNX_HOST}/usr/bin/qcc${HOST_EXECUTABLE_SUFFIX})
set (CMAKE_CXX_COMPILER_TARGET gcc_ntoarmv7le_gpp)
set (CMAKE_CXX_FLAGS_DEBUG "-g -std=gnu++0x -fpack-struct")
set (CMAKE_CXX_FLAGS_MINSIZEREL "-Os -DNDEBUG -std=gnu++0x -fpack-struct")
set (CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG -std=gnu++0x -fpack-struct")
set (CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g -std=gnu++0x")
