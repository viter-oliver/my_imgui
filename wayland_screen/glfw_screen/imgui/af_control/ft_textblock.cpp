...
namespace auto_future
{
	...
	void ft_textblock::draw()
	{
		...
		if (str_sz > 0)
		{
			...
			auto txtcl=_txt_pt._txt_clr;
			g_pfont_face_manager->draw_wstring(font_name, _txt_pt._font_size, draw_pos, end_pos, _txt_pt._font_scale, draw_content, txtcl, width, _txt_pt._omit_rest);
		}
